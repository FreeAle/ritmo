...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header>\r\n    <ion-toolbar>\r\n      <ion-buttons slot=\"start\">\r\n        <ion-button fill=\"clear\" (click)=\"dismiss()\">\r\n          <ion-icon name=\"close\"></ion-icon>\r\n        </ion-button>\r\n      </ion-buttons>\r\n      <ion-title>JUMP</ion-title>\r\n    </ion-toolbar>\r\n  </ion-header>\r\n  \r\n  <ion-content fullscreen>\r\n    <ion-card>\r\n      <img src=\"https://ritmodobrazil.com/newsite/wp-content/uploads/2020/10/IMG_20200912_132010_3441869.jpg\" />\r\n      <ion-card-header>\r\n        <ion-card-title>JUMP BY RDB</ion-card-title>\r\n      </ion-card-header>\r\n      <ion-card-content>\r\n        JUMP BY RITMO DO BRAZIL Nasce da un’idea di Andrè Cruz (Brazuca Fitness Creator e Gabriela Gonzalez in \r\n        collaborazione con Tiago da Silva (Sambafit Official Creator) JUMP by Ritmo do Brazil è l' evoluzione di \r\n        Brazuca Jump. Jump by ritmo do Brazil è un programma di allenamento nato per sfruttare al meglio le potenzialità \r\n        che l'attrezzo trampolino elastico può dare. Mediante L'utilizzo di questo fantastico attrezzo , \r\n        l'allenamento diventa di tipo aerobico , ad alto impatto e di resistenza muscolare. Jump by ritmo do Brazil \r\n        utilizza musiche e ritmi brasiliani redendo la lezione innovativa , coinvolgente più divertente ed adatta a tutti. \r\n        La struttura della lezione si basa sul metodo pre-coreografato che garantisce agli istruttori ed all'utente finale \r\n        una maggior padronanza del proprio corpo e di conseguenza del proprio allenamento. Adatto ad ogni tipologia di \r\n        clientela. Ritmo do brazil nasce dalla collaborazione tra André Cruz (Brazuca fitness) e Tiago Da Silva \r\n        (sambafit official) creando così un format esplosivo e unico che porta agli appassionati della danza e del \r\n        fitness il meglio della cultura brasiliana senza perdere di vista le caratteristiche di queste due dicipline \r\n        tra le piu note e quotate nel mondo del fitness internazionale.\r\n      </ion-card-content>\r\n    </ion-card>\r\n  </ion-content>");
...
/* harmony import */ var _modals_login_login_page__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modals/login/login.page */ "./src/app/modals/login/login.page.ts");
/* harmony import */ var _modals_sign_up_sign_up_page__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modals/sign-up/sign-up.page */ "./src/app/modals/sign-up/sign-up.page.ts");
/* harmony import */ var _modals_language_language_page__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./modals/language/language.page */ "./src/app/modals/language/language.page.ts");
/* harmony import */ var _modals_currency_list_currency_list_page__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./modals/currency-list/currency-list.page */ "./src/app/modals/currency-list/currency-list.page.ts");
/* harmony import */ var _modals_demo_settings_demo_settings_page__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./modals/demo-settings/demo-settings.page */ "./src/app/modals/demo-settings/demo-settings.page.ts");
/* harmony import */ var src_providers_app_events_app_events_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! src/providers/app-events/app-events.service */ "./src/providers/app-events/app-events.service.ts");
...
let AppComponent = class AppComponent {
    constructor(shared, config, router, navCtrl, platform, modalCtrl, statusBar, storage, network, loading, admobFree, appEventsService, plt, appVersion, iab, socialSharing, deeplinks, menuCtrl, zone, OneSignal) {
        this.shared = shared;
        this.config = config;
        this.router = router;
        ...
        this.a1 = [
            {
                ...
                items: [
                    { name: "1", url: '/home', login: true },
                    { name: "2", url: '/home2', login: true, },
                    { name: "3", url: '/home3', login: true, },
                    { name: "4", url: '/home4', login: true, },
                    { name: "5", url: '/home5', login: true, },
                    { name: "6", url: '/home6', login: true, },
                    { name: "7", url: '/home7', login: true, },
                    { name: "8", url: '/home8', login: true, },
                    { name: "9", url: '/home9', login: true, },
                    { name: "10", url: '/home10', login: true, }
                ],
                expanded: false
            },
            {
        ...
        this.a2 = [
            { name: 'Home', icon: 'home', url: 'home', login: true, img: 'assets/left-menu-icon/home.png' },
            { name: 'Categories', icon: 'apps', url: 'categories', img: 'assets/left-menu-icon/category.png' },
            {
                name: 'Shop', icon: 'cash', url: '/products', login: true, img: 'assets/left-menu-icon/shop.png',
                items: [
                    { name: "Newest", url: '/products/0/0/newest' },
                    { name: "On Sale", url: '/products/0/0/sale' },
                    { name: "Featured", url: '/products/0/0/featured' },
        ...
        this.a4 = [
            ...
            { name: 'About Us', icon: 'information-circle', img: 'assets/left-menu-icon/about.png', url: '/about-us', value: 'aboutUsPage' },
            { name: 'News', icon: 'newspaper', img: 'assets/left-menu-icon/news.png', url: '/news', value: 'newsPage' },
            { name: 'Intro', icon: 'caret-forward', img: 'assets/left-menu-icon/intro.png', login: true, url: '/intro', value: 'introPage' },
            { name: 'Share', icon: 'share', img: 'assets/left-menu-icon/share.png', url: 'share', value: 'sharePage' },
            { name: 'Rate Us', icon: 'star-half', img: 'assets/left-menu-icon/rating.png', url: 'rateUs', value: 'ratePage' },
            { name: 'Settings', icon: 'settings', img: 'assets/left-menu-icon/setting.png', url: '/settings', value: 'settingsPage' }
        ];
    ...
    getStatusBarColor() {
        let headerColor = jquery__WEBPACK_IMPORTED_MODULE_15__('#primary').css('color');
        ...
        let color = jquery__WEBPACK_IMPORTED_MODULE_15__('#my').css('color');
        let rgb = color;
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_providers_shared_data_shared_data_service__WEBPACK_IMPORTED_MODULE_6__["SharedDataService"],
        ...
        src_providers_app_events_app_events_service__WEBPACK_IMPORTED_MODULE_22__["AppEventsService"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"],
...
/* harmony import */ var _ionic_native_facebook_ngx__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! @ionic-native/facebook/ngx */ "./node_modules/@ionic-native/facebook/ngx/index.js");
...
/* harmony import */ var src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! src/pipes/pipes.module */ "./src/pipes/pipes.module.ts");
/* harmony import */ var _modals_refund_policy_refund_policy_module__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./modals/refund-policy/refund-policy.module */ "./src/app/modals/refund-policy/refund-policy.module.ts");
/* harmony import */ var _modals_currency_list_currency_list_module__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./modals/currency-list/currency-list.module */ "./src/app/modals/currency-list/currency-list.module.ts");
/* harmony import */ var _modals_login_login_module__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./modals/login/login.module */ "./src/app/modals/login/login.module.ts");
/* harmony import */ var _modals_sign_up_sign_up_module__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./modals/sign-up/sign-up.module */ "./src/app/modals/sign-up/sign-up.module.ts");
/* harmony import */ var _modals_forgot_password_forgot_password_module__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./modals/forgot-password/forgot-password.module */ "./src/app/modals/forgot-password/forgot-password.module.ts");
/* harmony import */ var _modals_privacy_policy_privacy_policy_module__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./modals/privacy-policy/privacy-policy.module */ "./src/app/modals/privacy-policy/privacy-policy.module.ts");
/* harmony import */ var _modals_select_country_select_country_module__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./modals/select-country/select-country.module */ "./src/app/modals/select-country/select-country.module.ts");
/* harmony import */ var _modals_select_zones_select_zones_module__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./modals/select-zones/select-zones.module */ "./src/app/modals/select-zones/select-zones.module.ts");
/* harmony import */ var _modals_scratch_card_scratch_card_module__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./modals/scratch-card/scratch-card.module */ "./src/app/modals/scratch-card/scratch-card.module.ts");
/* harmony import */ var _modals_term_services_term_services_module__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./modals/term-services/term-services.module */ "./src/app/modals/term-services/term-services.module.ts");
/* harmony import */ var _modals_language_language_module__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./modals/language/language.module */ "./src/app/modals/language/language.module.ts");
/* harmony import */ var _modals_blank_modal_blank_modal_module__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./modals/blank-modal/blank-modal.module */ "./src/app/modals/blank-modal/blank-modal.module.ts");
/* harmony import */ var _ionic_native_photo_viewer_ngx__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! @ionic-native/photo-viewer/ngx */ "./node_modules/@ionic-native/photo-viewer/ngx/index.js");
/* harmony import */ var _modals_demo_settings_demo_settings_module__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./modals/demo-settings/demo-settings.module */ "./src/app/modals/demo-settings/demo-settings.module.ts");
/* harmony import */ var _ionic_native_local_notifications_ngx__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! @ionic-native/local-notifications/ngx */ "./node_modules/@ionic-native/local-notifications/ngx/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _components_menu_component_menu_component_component__WEBPACK_IMPORTED_MODULE_26__["MenuComponentComponent"],
        ],
        entryComponents: [],
        imports: [
            ...
            src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_29__["PipesModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_28__["FormsModule"],
            _modals_blank_modal_blank_modal_module__WEBPACK_IMPORTED_MODULE_41__["BlankModalPageModule"],
            _modals_language_language_module__WEBPACK_IMPORTED_MODULE_40__["LanguagePageModule"],
            _modals_refund_policy_refund_policy_module__WEBPACK_IMPORTED_MODULE_30__["RefundPolicyPageModule"],
            _modals_currency_list_currency_list_module__WEBPACK_IMPORTED_MODULE_31__["CurrencyListPageModule"],
            _modals_login_login_module__WEBPACK_IMPORTED_MODULE_32__["LoginPageModule"],
            _modals_sign_up_sign_up_module__WEBPACK_IMPORTED_MODULE_33__["SignUpPageModule"],
            _modals_forgot_password_forgot_password_module__WEBPACK_IMPORTED_MODULE_34__["ForgotPasswordPageModule"],
            _modals_privacy_policy_privacy_policy_module__WEBPACK_IMPORTED_MODULE_35__["PrivacyPolicyPageModule"],
            _modals_term_services_term_services_module__WEBPACK_IMPORTED_MODULE_39__["TermServicesPageModule"],
            _modals_select_country_select_country_module__WEBPACK_IMPORTED_MODULE_36__["SelectCountryPageModule"],
            _modals_select_zones_select_zones_module__WEBPACK_IMPORTED_MODULE_37__["SelectZonesPageModule"],
            _modals_scratch_card_scratch_card_module__WEBPACK_IMPORTED_MODULE_38__["ScratchCardPageModule"],
            _modals_demo_settings_demo_settings_module__WEBPACK_IMPORTED_MODULE_43__["DemoSettingsPageModule"],
        ],
        providers: [
            ...
            _ionic_native_facebook_ngx__WEBPACK_IMPORTED_MODULE_27__["Facebook"],
            _ionic_native_email_composer_ngx__WEBPACK_IMPORTED_MODULE_19__["EmailComposer"],
            _ionic_native_photo_viewer_ngx__WEBPACK_IMPORTED_MODULE_42__["PhotoViewer"],
...
let LoginPage = class LoginPage {
    constructor(http, config, modalCtrl, loading, shared, fb, applicationRef, navCtrl, appEventsService, navParams, alertController) {
        this.http = http;
        this.config = config;
        this.modalCtrl = modalCtrl;
        this.loading = loading;
...
/* harmony import */ var _sanitize_html_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sanitize-html.pipe */ "./src/pipes/sanitize-html.pipe.ts");
/* harmony import */ var _translate_app_translate_app_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./translate-app/translate-app.pipe */ "./src/pipes/translate-app/translate-app.pipe.ts");
...
sanitizeHtmlPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({ name: 'sainitizeHtml', pure: false }),
...
/* harmony import */ var _loading_loading_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../loading/loading.service */ "./src/providers/loading/loading.service.ts");
...
SharedDataService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"],
        ...
        _ionic_storage__WEBPACK_IMPORTED_MODULE_4__["Storage"],
        _loading_loading_service__WEBPACK_IMPORTED_MODULE_6__["LoadingService"],
...
module.exports = __webpack_require__(/*! C:\Users\Alessandro\Desktop\ritmoapp\src\main.ts */"./src/main.ts");
