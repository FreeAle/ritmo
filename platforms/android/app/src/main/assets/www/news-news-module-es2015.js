...
let NewsPage = class NewsPage {
    constructor(navCtrl, http, config, loading, shared, alertCtrl) {
    ...
    //Aggiornamenti 2020
    getCategories11() {
        this.config.getWithUrl(this.config.url + '/wp-json/wp/v2/categories/20').then((data) => {
            if (this.page2 == 1) {
                this.categories11 = [];
            }
    ...
    //Aggiornamenti 2021
    getCategories111() {
        this.config.getWithUrl(this.config.url + '/wp-json/wp/v2/categories/21').then((data) => {
            if (this.page2 == 1) {
                this.categories111 = [];
            }
    ...
    //Maculele
    getCategories1111() {
        this.config.getWithUrl(this.config.url + '/wp-json/wp/v2/categories/22').then((data) => {
            if (this.page2 == 1) {
                this.categories1111 = [];
            }
    ...
    //Jump
    getCategories2() {
        this.config.getWithUrl(this.config.url + '/wp-json/wp/v2/categories/3').then((data) => {
            if (this.page2 == 1) {
                this.categories2 = [];
            }
    ...
    getPosts1() {
        ...
        this.config.getWithUrl(this.config.url + '/wp-json/wp/v2/posts/?page=' + this.page + "&categories=" + "2" + "&" + this.config.productsArguments).then((data) => {
            this.infinite.complete(); //stopping infinite scroll loader
            if (this.page == 1) {
                this.posts = [];
                this.infinite.disabled = false;
    ...
    getPosts2() {
        ...
        this.config.getWithUrl(this.config.url + '/wp-json/wp/v2/posts/?page=' + this.page + "&categories=" + "3" + "&" + this.config.productsArguments).then((data) => {
            this.infinite.complete(); //stopping infinite scroll loader
            if (this.page == 1) {
                this.posts = [];
                this.infinite.disabled = false;
