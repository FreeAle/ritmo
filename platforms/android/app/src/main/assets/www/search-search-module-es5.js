    ...
    var SearchPage = /*#__PURE__*/function () {
      function SearchPage(navCtrl, config, http, loading, shared, applicationRef) {
        ...
        this.getSearchData = function () {
          ...
          this.loading.show();
          this.config.getWoo("products?status=publish&per_page=70&search=" + this.search + "&" + this.config.productsArguments).then(function (data) {
            _this.loading.hide();

            _this.searchResult = data;
            _this.searchSku = true;
      ...
      _createClass(SearchPage, [{
        key: "openProducts",
        value: function openProducts(id, name, sku) {
