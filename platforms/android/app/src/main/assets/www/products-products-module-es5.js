    ...
    var ProductsPage = /*#__PURE__*/function () {
      ...
      _createClass(ProductsPage, [{
        ...
        value: function getFilterdProducts(value) {
          ...
          var query = '&page=' + this.page + '&per_page=70';
          if (this.sortOrder == "Newest") query = query + "&order=desc&order_by=_sku";else if (this.sortOrder == "A - Z") query = query + "&order=asc&order_by=title";else if (this.sortOrder == "Z - A") query = query + "&order=desc&order_by=title";
        ...
        value: function getFilterdProductsFromWoo() {
          ...
          var q = 'products?include=' + this.listOfFilteredIdsFromCustom + "&status=publish&per_page=70"; //console.log(this.listOfFilteredIdsFromCustom);

          if (this.sortOrder == "Newest") q = q + "&order=desc&order_by=_sku";else if (this.sortOrder == "A - Z") q = q + "&order=asc&order_by=title";else if (this.sortOrder == "Z - A") q = q + "&order=desc&order_by=title"; // if (this.type == "featured" || this.filterFeatured) { q = q + "&featured=true"; this.filterFeatured = true; }
